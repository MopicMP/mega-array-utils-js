...
> Mega array unique, chunk, shuffle, flatten for js

[![npm version](https://badge.fury.io/js/mega-array-utils-js.svg)](https://www.npmjs.com/package/mega-array-utils-js)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install mega-array-utils-js
```

## Quick Start

```javascript
const { js } = require('mega-array-utils-js');
...
```javascript
const { js, batch } = require('mega-array-utils-js');
